...
export const QuickAddClient: React.FC = () => {
  ...
  const userRole = user?.role?.name
  const pageTitle = userRole === 'distributor' ? 'Add New Client' : 'Add New Client'
  const backButtonText = userRole === 'distributor' ? 'Back to Network' : 'Back to Clients'
            ...
            <HStack spacing={3}>
              ...
              <VStack align="start" spacing={0}>
                ...
                <Text fontSize="md" color="gray.600">
                  Create a new client organization under your network
                </Text>
              </VStack>
            </HStack>
          </VStack>
