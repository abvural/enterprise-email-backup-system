...
// GetTotalStorageStats returns storage statistics for the user
...
func GetAccountStorageStats(c *gin.Context) {
...
func GetFolderStorageStats(c *gin.Context) {
	_ = c.Param("accountId")
	c.JSON(http.StatusOK, gin.H{
		"folder_stats": []gin.H{
			{
...
func RecalculateStorageStats(c *gin.Context) {
	accountID := c.Param("accountId")
	c.JSON(http.StatusOK, gin.H{
		"message": "Storage statistics recalculated",
		"account_id": accountID,
	})
}